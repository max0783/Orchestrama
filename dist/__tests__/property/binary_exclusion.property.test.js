...
describe("Property 18: Binary file exclusion", () => {
    it("files containing null bytes are excluded from the payload", async () => {
        ...
        fc.string({ maxLength: 50 }), fc.string({ maxLength: 50 }), async (prefix, suffix) => {
    ...
    it("binary files are excluded even when .bridgeignore is empty", async () => {
        ...
        }), { minLength: 1, maxLength: 8 }), async (fileSpecs) => {
            // Deduplicate names
            const seen = new Set();
...
//# sourceMappingURL=binary_exclusion.property.test.js.map