...
describe("Property 3: Map-phase context isolation", () => {
    it("every Map-phase Ollama call is sent with context: null", async () => {
        ...
        fc.string({ minLength: 500, maxLength: 3000 }), async (contextWindow, payload) => {
    ...
    it("context returned by one chunk is not passed to the next chunk in Map phase", async () => {
        ...
        fc.integer({ min: 20, max: 100 }), fc.array(fc.string({ minLength: 50, maxLength: 200 }), { minLength: 3, maxLength: 10 }), async (contextWindow, words) => {
...
//# sourceMappingURL=context_isolation.property.test.js.map