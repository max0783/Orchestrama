...
describe("Property 21: Queue-full rejection", () => {
    it("throws QueueFullError when the waiting queue is at maxSize capacity", async () => {
        await fc.assert(fc.asyncProperty(
        // maxSize between 1 and 5 — small enough to fill quickly
        fc.integer({ min: 1, max: 5 }), async (maxSize) => {
            ...
            expect(thrownError.code).toBe("queue_full");
        }), { numRuns: 100 });
    }, 
    // Allow enough time for 100 runs.
    60_000);
});
//# sourceMappingURL=queue_full.property.test.js.map