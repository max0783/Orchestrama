...
const arbReductionRecord = fc.record({
...
describe("Property 13: Reduction record completeness", () => {
    ...
    it("appended record appears in the log with all required fields intact", async () => {
        await fc.assert(fc.asyncProperty(arbReductionRecord, async (record) => {
...
//# sourceMappingURL=reduction_record.property.test.js.map