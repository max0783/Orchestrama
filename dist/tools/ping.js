 ...
 */
export function createPingHandler(ollamaClient, defaultModel) {
    return async (args) => {
        ...
        process.stderr.write(`[ollama-mcp-bridge] ping_model: ${model} - ${status} start (${result.responseTimeMs}ms)\n`);
